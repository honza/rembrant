...
(function() {
  ...
  Rembrant = (function() {
    ...
    Rembrant.prototype.generateIndex = function() {
      ...
      return this.finalizeFile(html, 'index.html');
    };
    ...
    Rembrant.prototype.generateAlbums = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        this.finalizeFile(html, "album-" + album.id + ".html");
      }
      html = eco.render(template, {
        photos: this.library.photos
      });
      return this.finalizeFile(html, 'all.html');
    };
    ...
    Rembrant.prototype.generatePages = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(this.finalizeFile(html, "" + (photo.getHtmlName())));
      }
      return _results;
    };
